...
class K8Assets
{
	...
	public function load_scripts() {
		...
		wp_register_style( 'k8_sh_coupon-css-main', get_template_directory_uri() . '/templz/shortcodes/K8_SH_COUPON/build/static/css/main.2707d0cc.chunk.css', array(), rand(1,9999), 'all' );
