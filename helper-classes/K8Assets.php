...
class K8Assets
{
	public function __construct()
	{
		...
		if( get_site_url() == 'https://test1.vpntester.org' || get_site_url() == 'https://vpntester.org' || get_site_url() == 'https://dev.vpnanbietervergleich.de' ){
	...
	public function load_scripts() {
		...
		wp_register_style( 'k8_sh_coupon-css-main', get_template_directory_uri() . '/templz/shortcodes/K8_SH_COUPON/build/static/css/main.9780b173.chunk.css', array(), rand(1,9999), 'all' );
	...
	public function admin_style(){
		wp_register_style( 'k8-admin-style-css', get_template_directory_uri() . '/k8/admin/css/k8-admin-style.css', array(), rand(1,1000), 'all' );
