...
jQuery(document).ready(function ($) {
  ...
  var retrieveLocal = function retrieveLocal() {
    ...
    if (k8PhnSucc != null) {
      var $body = $('body'),
          ...
          notif = "<div class='m5-notif'>" + "<span class='m5-notif__close'><i class='fas fa-times'></i></span>" + "<div class='m5-notif__inner'>" + "<div class='m5-notif__txt'>" + "<p>Du hast die telefonische Verifikation bereits abgeschlossen.  <br />Dein Gutscheincode lautet: <b>" + parsedd.code + "</b>. Du kannst diesen Coupon hier <a rel='nofollow' target='__blank' href='" + parsedd.redirect_url + "'>" + parsedd.anbieter + "</a> einlösen.</p>" + "</div>" + "<div class='m5-notif__btnz'>" + "<button class='m5-notif__btn'>Ich habe den Coupon bereits aktiviert</button>" + "</div>" + "</div>" + "</div>";
  ...
  function sentGoogleAnalitic(gtagOpts) {
    if (gtag) {
      gtag.apply(void 0, _toConsumableArray(gtagOpts));
    }
  ...
  $('body').on('click', '.k8_yt-link', function (event) {
    ...
    sentGoogleAnalitic(['event', 'a1_play', {
