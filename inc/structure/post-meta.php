		...
		if ( in_array( get_post_type(), $post_types ) ) :
			...
			<div class="entry-meta tbl k8-meta__tbl">
				<div class="tbl-cell mdl k8-meta__img">
					<img style="width: 70px; height: 70px;" class="k8-round" width="70" height="70" src="<?php echo ( $k8_acf_u_ph ) ? K8Help::getImgUrl( $k8_acf_u_ph, 'thumbnail' ) : bloginfo( 'template_directory' ) . '/img/default-user-100.jpg' ; ?>">
				</div>
